				...
				<div class="col-lg-3 col-md-3 col-sm-12">
					<div class="card">
						...
						<div class="card-body">
						 ...
						 <h6 class="card-title bg-danger text-white p-2"> EGP <?php echo $items['price'];  ?></h6> 
...
?>
	...
	<div class="text-center text-danger mb-3" style="padding-top: 20px;">
					<input type="hidden" name="total_amount" value="<?php echo $tot; ?>">
					<h4>
					...
					<select class="selectpicker" name="delivery">
							<option value="1">Normal (+ 50 EGP)</option>
							<option value="2">Express (+ 150 EGP)</option>
					</select>
	</div>
	...
	<div class="text-center text-danger mb-5">
			<button name="payment" class="btn btn-info" >Confirm & Pay EGP <?php echo $tot;?> + Shipping </button>
	</div>
</form>
