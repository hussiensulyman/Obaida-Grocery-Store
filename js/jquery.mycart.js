...
(function ($) {
  ...
  var loadMyCartEvent = function(userOptions){
    ...
    var drawTable = function(){
      ...
      $.each(products, function(){
        ...
        $cartTable.append(
          ...
          '<td>' + this.name + '</td>' +
          '<td title="Unit Price">EGP ' + this.price + '</td>' +
          '<td title="Quantity"><input type="number" min="1" style="width: 70px;" class="' + classProductQuantity + '" value="' + this.quantity + '"/></td>' +
          '<td title="Total" class="' + classProductTotal + '">EGP ' + total + '</td>' +
      ...
      $cartTable.append(products.length ?
        ...
        '<td></td>' +
        '<td></td>' +
        '<td><strong id="' + idGrandTotal + '"> EGP </strong></td>' +
        '<td></td>' +
        '</tr>'
      ...
      if(products.length && discountPrice !== null) {
        $cartTable.append(
          ...
          '<td></td>' +
          '<td></td>' +
          '<td><strong id="' + idDiscountPrice + '"> EGP </strong></td>' +
          '<td></td>' +
          '</tr>'
        );
      }
    ...
    var showGrandTotal = function(){
      $("#" + idGrandTotal).text("EGP " + ProductManager.getTotalPrice());
    }
    var showDiscountPrice = function(){
      $("#" + idDiscountPrice).text("EGP " + options.getDiscountPrice(ProductManager.getAllProducts(), ProductManager.getTotalPrice(), ProductManager.getTotalQuantity()));
    }
    ...
    */
    ...
    $(document).on("input", "." + classProductQuantity, function () {
      ...
      $(this).parent("td").next("." + classProductTotal).text("EGP " + price * quantity);
