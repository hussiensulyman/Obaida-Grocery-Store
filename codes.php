							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu multi multi1">
									<div class="row">
										<div class="col-sm-3">
											<ul class="multi-column-dropdown">
												<li><a href="care.php?name=ayurvedic"><i class="fa fa-angle-right" aria-hidden="true"></i> Ayurvedic </a></li>
												<li><a href="care.php?name=babycare"><i class="fa fa-angle-right" aria-hidden="true"></i>Baby Care</a></li>
												<li><a href="care.php?name=cosmetics"><i class="fa fa-angle-right" aria-hidden="true"></i>Cosmetics</a></li>
												<li><a href="care.php?name=deo_and_perfumes"><i class="fa fa-angle-right" aria-hidden="true"></i>Deo & Purfumes</a></li>
										...
										<div class="col-sm-3">
											...
											<ul class="multi-column-dropdown">
												<li><a href="care.php?name=haircare"> <i class="fa fa-angle-right" aria-hidden="true"></i>Hair Care </a></li>
												<li><a href="care.php?name=oralcare"><i class="fa fa-angle-right" aria-hidden="true"></i>Oral Care</a></li>
												<li><a href="care.php?name=personal_hygiene"><i class="fa fa-angle-right" aria-hidden="true"></i>Personal Hygiene</a></li>
												<li><a href="care.php?name=skincare"><i class="fa fa-angle-right" aria-hidden="true"></i>Skin care</a></li>
										...
										<div class="col-sm-3">
											...
											<ul class="multi-column-dropdown">
												<li><a href="care.php?name=fashion_accessories"><i class="fa fa-angle-right" aria-hidden="true"></i> Fashion Accessories </a></li>
												<li><a href="care.php?name=grooming_tools"><i class="fa fa-angle-right" aria-hidden="true"></i>Grooming Tools</a></li>
												<li><a href="care.php?name=shaving_needs"><i class="fa fa-angle-right" aria-hidden="true"></i>Shaving Need</a></li>
												<li><a href="care.php?name=sanitary_needs"><i class="fa fa-angle-right" aria-hidden="true"></i>Sanitary Needs</a></li>
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu multi multi1">
									<div class="row">
										<div class="col-sm-3">
											<ul class="multi-column-dropdown">
												<li><a href="snacks.php?name=noodles_and_pasta"><i class="fa fa-angle-right" aria-hidden="true"></i> Noodles and Pasta </a></li>
												<li><a href="snacks.php?name=breakfast_cereals"><i class="fa fa-angle-right" aria-hidden="true"></i>Breakfast Cereals</a></li>
												<li><a href="snacks.php?name=biscuit_and_cookies"><i class="fa fa-angle-right" aria-hidden="true"></i>Biscuits and Cookies</a></li>
										...
										<div class="col-sm-3">
											...
											<ul class="multi-column-dropdown">
												<li><a href="snacks.php?name=sauces_and_ketchups"> <i class="fa fa-angle-right" aria-hidden="true"></i>Sauces and Ketchups </a></li>
												<li><a href="snacks.php?name=chocolates_and_candies"><i class="fa fa-angle-right" aria-hidden="true"></i>Chocolates and Candies</a></li>
												<li><a href="snacks.php?name=frozen_veggies"><i class="fa fa-angle-right" aria-hidden="true"></i>Frozen Veggies</a></li>
										...
										<div class="col-sm-3">
											...
											<ul class="multi-column-dropdown">
												<li><a href="snacks.php?name=snacks_and_namkeen"><i class="fa fa-angle-right" aria-hidden="true"></i> Snacks and Namkeen </a></li>
												<li><a href="snacks.php?name=pickle_and_condiment"><i class="fa fa-angle-right" aria-hidden="true"></i>Pickles and Chutneys</a></li>
												<li><a href="snacks.php?name=indian_mithai"><i class="fa fa-angle-right" aria-hidden="true"></i>Indian Mithai</a></li>
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu multi multi1">
									<div class="row">
										<div class="col-sm-3">
											<ul class="multi-column-dropdown">
												<li><a href="bake.php?name=breads_and_buns"><i class="fa fa-angle-right" aria-hidden="true"></i> Breads and Buns </a></li>
												<li><a href="bake.php?name=dairy"><i class="fa fa-angle-right" aria-hidden="true"></i>Dairy </a></li>
												<li><a href="bake.php?name=cakes_and_pastries"><i class="fa fa-angle-right" aria-hidden="true"></i>Cakes and Pastries </a></li>
												<li><a href="bake.php?name=rusk_and_khari"><i class="fa fa-angle-right" aria-hidden="true"></i>Cookies, Rusk and Khari</a></li>
										...
										<div class="col-sm-3">
											...
											<ul class="multi-column-dropdown">
												<li><a href="bake.php?name=eggs"> <i class="fa fa-angle-right" aria-hidden="true"></i>Eggs </a></li>
												<li><a href="bake.php?name=poultry"><i class="fa fa-angle-right" aria-hidden="true"></i>Poultry</a></li>
												<li><a href="bake.php?name=mutton_and_lamb"><i class="fa fa-angle-right" aria-hidden="true"></i>Mutton and Lamb</a></li>										
											</ul>
										...
										<div class="col-sm-3">
											...
											<ul class="multi-column-dropdown">
												<li><a href="bake.php?name=fish_and_seafood"><i class="fa fa-angle-right" aria-hidden="true"></i> Fish and Seafood </a></li>
												<li><a href="bake.php?name=pork_and_others"><i class="fa fa-angle-right" aria-hidden="true"></i>Pork and Other Meats </a></li>
												<li><a href="bake.php?name=icecream"><i class="fa fa-angle-right" aria-hidden="true"></i>Ice- Creams and Desserts</a></li>										
											</ul>
										</div>
										<div class="col-sm-3 w3l">
											<a href="care.php"><img src="images/me1.png" class="img-responsive" alt=""></a>
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu multi multi2">
									<div class="row">
										<div class="col-sm-3">
											<ul class="multi-column-dropdown">
												<li><a href="hold.php?name=cleaning_accessories"><i class="fa fa-angle-right" aria-hidden="true"></i>Cleaning Accessories</a></li>
												<li><a href="hold.php?name=cookwear"><i class="fa fa-angle-right" aria-hidden="true"></i>CookWear</a></li>
												<li><a href="hold.php?name=detergents"><i class="fa fa-angle-right" aria-hidden="true"></i>Detergents</a></li>
												<li><a href="hold.php?name=gardening"><i class="fa fa-angle-right" aria-hidden="true"></i>Gardening Needs</a></li>
										...
										<div class="col-sm-3">
											...
											<ul class="multi-column-dropdown">
												<li><a href="hold.php?name=pooja_needs"><i class="fa fa-angle-right" aria-hidden="true"></i>Pooja Needs</a></li>
												<li><a href="hold.php?name=safety_accessories"><i class="fa fa-angle-right" aria-hidden="true"></i>Safety Accessories</a></li>
												<li><a href="hold.php?name=festive_decoratives"><i class="fa fa-angle-right" aria-hidden="true"></i>Festive Decoratives </a></li>
