...
<div class="header">
		...
		<div class="container">
			...
			<div class="logo">
				<h1 ><a href="index.php"><b>T<br>H<br>E</b>Obaida Grocery Store<br/><span>The Best Supermarket</span></a></h1>
			</div>
				...
				<div class=" tab-content tab-content-t ">
					<div class="tab-pane active text-style" id="tab1">
						...
						<?php 
								...
								$q2= "SELECT *, isEgyptian FROM products WHERE vendor_name='$vendor' AND product_cat=17 LIMIT 4";
					...
					<div class="tab-pane  text-style" id="tab2">
						...
						<?php 
								...
								/*echo $vendor;*/
								$q2= "SELECT *, isEgyptian FROM products WHERE vendor_name='$vendor' AND product_cat=20 LIMIT 4";
								$data2= mysqli_query($conn, $q2);
								$total2= mysqli_num_rows($data2);
					...
					<div class="tab-pane  text-style" id="tab3">
						...
						<?php 
								...
								/*echo $vendor;*/
								$q2= "SELECT *, isEgyptian FROM products WHERE vendor_name='$vendor' AND product_cat=16 LIMIT 4";
								$data2= mysqli_query($conn, $q2);
								$total2= mysqli_num_rows($data2);
					...
					<div class="tab-pane text-style" id="tab4">
						...
						<?php 
								...
								/*echo $vendor;*/
								$q2= "SELECT *, isEgyptian FROM products WHERE vendor_name='$vendor' AND product_cat=19 LIMIT 4";
								$data2= mysqli_query($conn, $q2);
								$total2= mysqli_num_rows($data2);
			...
			<div class="spec ">
				...
				<div class=" con-w3l">
					<?php 
								...
								/*echo $vendor;*/
								$q2= "SELECT *, isEgyptian FROM products LIMIT 16, 24";
								$data2= mysqli_query($conn, $q2);
								$total2= mysqli_num_rows($data2);
					...
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
								...
								<div class="col-md-7 span-1 ">
									...
									<p class="in-para"> Some attractive Heading</p>
									<div class="price_single">
									  <span class="reducedfrom "><del> EGP 7.00</del> EGP 6.00</span>
					...
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
								...
								<div class="col-md-7 span-1 ">
									...
									<p class="in-para"> Some attractive Heading</p>
									<div class="price_single">
									  <span class="reducedfrom "><del> EGP 5.00</del> EGP 4.50</span>
					...
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
								...
								<div class="col-md-7 span-1 ">
									...
									<p class="in-para"> Some attractive Heading</p>
									<div class="price_single">
									  <span class="reducedfrom "><del> EGP 1.00</del> EGP 0.80</span>
